...
| 008 | Headless Windows Mode (no console)      | 007        | Implemented |
| 009 | Windows System Tray Icon                | 008        | Implemented |
| 010 | Tray Polish (badge, toasts, log window) | 009        | Implemented |
